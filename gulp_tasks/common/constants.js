...
module.exports = function() {
    ...
    var constants = {
        ...
        repository: 'https://github.com/ackushiw/ackushiw',
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './bower_components/bootstrap/dist/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
        ...
        serve: {
            ...
            localtunnel: false // true, false or 'ackushiw'
        },
        mocha: {
            libs: ['server/**/*.js'],
            tests: ['test/mocha/**/*.js'],
